...
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre v-pre><code><span class="line"><span class="token function">npm</span> <span class="token function">install</span> toolspad</span>
...
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts" data-title="ts"><pre v-pre><code><span class="line"><span class="token comment">// 按需引入</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="示例" tabindex="-1"><a class="header-anchor" href="#示例"><span>示例</span></a></h3>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts" data-title="ts"><pre v-pre><code><span class="line"><span class="token comment">// 防抖示例</span></span>
...
<p>toolspad 提供了丰富的工具函数，您可以根据实际需求按需引入使用。每个函数都经过精心设计和测试，确保其可靠性和易用性。</p>
</div>
<div class="hint-container warning">
<p class="hint-container-title">注意</p>
<p>在使用某些函数时，请注意查看具体的参数要求和返回值说明，以确保正确使用。</p>
</div>
<h2 id="函数控制类" tabindex="-1"><a class="header-anchor" href="#函数控制类"><span>函数控制类</span></a></h2>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="函数调用次数限制执行-callnexec" tabindex="-1"><a class="header-anchor" href="#函数调用次数限制执行-callnexec"><span>函数调用次数限制执行（callNExec）</span></a></h3>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="可配置时间间隔的函数包装器-createintervalfn" tabindex="-1"><a class="header-anchor" href="#可配置时间间隔的函数包装器-createintervalfn"><span>可配置时间间隔的函数包装器（createIntervalFn）</span></a></h3>
<p><code v-pre>createIntervalFn</code> 函数用于创建一个可配置时间间隔的函数包装器，支持本地持久化存储上次执行时间，确保函数按照指定的时间间隔执行。这对于需要定期执行某些操作（如数据同步、状态检查等）的场景非常有用。</p>
<h4 id="_1-引入该方法-3" tabindex="-1"><a class="header-anchor" href="#_1-引入该方法-3"><span>1.引入该方法</span></a></h4>
<p>在基于 Vue 的项目中（以 <code v-pre>App.vue</code> 文件为例），引入 <code v-pre>createIntervalFn</code> 函数的方式如下：</p>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts" data-title="App.vue"><pre v-pre><code><span class="line"><span class="token keyword">import</span> <span class="token punctuation">{</span> createIntervalFn <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'toolspad'</span><span class="token punctuation">;</span></span>
<span class="line"></span></code></pre>
...
<h5 id="func-参数-1" tabindex="-1"><a class="header-anchor" href="#func-参数-1"><span><code v-pre>func</code> 参数</span></a></h5>
<ul>
<li><strong>类型</strong>：<code v-pre>Function | null</code></li>
<li><strong>描述</strong>：需要定期执行的函数，可以为 null。</li>
</ul>
<h5 id="options-参数" tabindex="-1"><a class="header-anchor" href="#options-参数"><span><code v-pre>options</code> 参数</span></a></h5>
<ul>
<li><strong>类型</strong>：<code v-pre>Object</code></li>
<li><strong>描述</strong>：配置选项对象，包含以下属性：
<ul>
<li><code v-pre>key</code>（必填）：用于本地存储的唯一标识符</li>
<li><code v-pre>interval</code>（可选）：间隔数值，默认为 1</li>
<li><code v-pre>unit</code>（可选）：时间单位，可选值包括：'second'、'minute'、'hour'、'day'、'month'、'year'，默认为 'day'</li>
</ul>
</li>
</ul>
<h4 id="_3-使用示例如下-1" tabindex="-1"><a class="header-anchor" href="#_3-使用示例如下-1"><span>3.使用示例如下</span></a></h4>
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts" data-title="App.vue"><pre v-pre><code><span class="line"><span class="token comment">// 创建一个每天执行一次的函数</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="数据处理类" tabindex="-1"><a class="header-anchor" href="#数据处理类"><span>数据处理类</span></a></h2>
<h3 id="深拷贝-deepcopy" tabindex="-1"><a class="header-anchor" href="#深拷贝-deepcopy"><span>深拷贝(deepCopy)</span></a></h3>
...
<div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts" data-title="App.vue"><pre v-pre><code><span class="line"></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="数组乱序-disorderarray" tabindex="-1"><a class="header-anchor" href="#数组乱序-disorderarray"><span>数组乱序（disorderArray）</span></a></h3>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="工具类" tabindex="-1"><a class="header-anchor" href="#工具类"><span>工具类</span></a></h2>
<h3 id="时间格式化函数-formatdate" tabindex="-1"><a class="header-anchor" href="#时间格式化函数-formatdate"><span>时间格式化函数（formatDate）</span></a></h3>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h4 id="_2-输入参数-5" tabindex="-1"><a class="header-anchor" href="#_2-输入参数-5"><span>2.输入参数</span></a></h4>
...
<h4 id="_3-使用示例如下-5" tabindex="-1"><a class="header-anchor" href="#_3-使用示例如下-5"><span>3.使用示例如下</span></a></h4>
...
<h4 id="_1-引入该方法-10" tabindex="-1"><a class="header-anchor" href="#_1-引入该方法-10"><span>1.引入该方法</span></a></h4>
